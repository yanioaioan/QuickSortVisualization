#############################################################################
# Makefile for building: QuickSortVisualization
# Generated by qmake (3.0) (Qt 5.5.0)
# Project:  QuickSortVisualization.pro
# Template: app
# Command: /opt/qt/5.5/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug -o Makefile QuickSortVisualization.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = QuickSortVisualization1.0.0
DISTDIR = /home/yioannidis/QuickSortVisualization/.tmp/QuickSortVisualization1.0.0
LINK          = g++
...
OBJECTS       = main.o
DIST          = deployment.pri \
		QuickSortVisualization.pro  main.cpp
QMAKE_TARGET  = QuickSortVisualization
DESTDIR       = #avoid trailing-slash linebreak
TARGET        = QuickSortVisualization
...
Makefile: QuickSortVisualization.pro ../.qmake.cache /opt/qt/5.5/gcc_64/mkspecs/linux-g++/qmake.conf /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		...
		QuickSortVisualization.pro
	$(QMAKE) -spec linux-g++ CONFIG+=debug -o Makefile QuickSortVisualization.pro
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/QuickSortVisualization/bin || mkdir -p $(INSTALL_ROOT)/opt/QuickSortVisualization/bin
	-$(INSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/QuickSortVisualization/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/QuickSortVisualization/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/QuickSortVisualization/bin/ 
